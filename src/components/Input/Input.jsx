    ...
    return (
        <div className=' w-[494px] max-md:w-full'>
            <div className="w-full flex gap-4 max-md:flex-col justify-center">
                <input type="text" placeholder={placeholder} className="border-[1px] border-[#D0D5DD] rounded-lg h-12 w-[360px] max-md:w-full pt-3 pb-3 pl-4 pr-3.5 outline-[#7F56D9] shadow-none" />
